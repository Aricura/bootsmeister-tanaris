...
<div class="item @if($raidMember->GuildMember->name == 'Aricura' or $raidMember->GuildMember->name == 'Tínkerbell') active @endif" id="team-carousel--{{ $raidMember->guild_member_id }}">
